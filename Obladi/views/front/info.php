              ...
              <div class="row align-items-end">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $_SESSION['nom']; ?>"   placeholder="nom">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="postcodezip">region</label>
                    <input type="text" class="form-control" name="region" value="<?php echo $_SESSION['region']; ?>" >
                  </div>
                </div>
                <div class="w-100"></div>
                <div class="col-md-6">
...
if (isset($_POST['modifier'])){
  $utilisateur=new utilisateur($_POST['nom'],$_POST['prenom'],$_POST['email'],$_POST['dateNaissance'],$_POST['mdp'],$_POST['numTel'],$_POST['region'],$_POST['prof'],$_SESSION['pointsFidelites'],true);
  $uc=new utilisateurC();
  $uc->modifierUtilisateur($utilisateur,$_POST['nom']);
  echo $_POST['nom'];
